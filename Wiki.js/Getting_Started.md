...
1. Visit [Naissance's Latest Release](https://github.com/ConfoederatioVF/Naissance/releases/tag/1.9.2b-skeleton) page.
2. Download Node.JS if not installed: [https://nodejs.org/en/download](https://nodejs.org/en/download).
...
![](/crd/naissance/getting_started_startup_screen.jpg)

The startup screen as it appears in 1.92b.
...
![](/crd/naissance/getting_started_change_basemap.png)

You have now learned how to use a basemap of your choice.
...
![](/crd/naissance/getting_started_brush.png)

The Brush as it appears by default.
...
![](/crd/naissance/getting_started_brussels.jpg)

A Brussels painted using the default Brush.
...
![](/crd/naissance/getting_started_wallonia_1.png)

A polygon before and after being edited.
...
![](/crd/naissance/getting_started_wallonia_2.jpg)

Node editors can subtract from a Polygon, similar to a lasso.
...
![](/crd/naissance/getting_started_belgium.jpg)

The snap to feature for layers. Don't worry about the hook in the northern Flemish border near Zeeland, it can be subtracted similarly.

It is perfectly fine for your lasso to overlap when sculpting Polygons. They will snap to existing borders in a layer by default.
...
![](/crd/naissance/getting_started_timeline.png)
...
- Next Tutorial: [Saving & Loading](Saving%20&%20Loading)