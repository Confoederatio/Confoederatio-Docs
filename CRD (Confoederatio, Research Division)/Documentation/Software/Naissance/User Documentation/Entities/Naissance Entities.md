...
[[CRD (Confoederatio, Research Division)/Documentation/Software/Naissance/Naissance]] entities are generally split into both [[Naissance Features]] and [[Naissance Geometries]], and are a user-facing term for any object in a Naissance project. It is not implemented as a class, and does not exist in backend terms.
